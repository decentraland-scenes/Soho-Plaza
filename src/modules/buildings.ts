...
Car_01.addComponent(new Transform({
	position: new Vector3(160, 0, 160),
	rotation: Quaternion.Euler(0, 0, 0)
}
))
...
Car_01_Collider.addComponent(new Transform({
	position: new Vector3(160, 0, 160),
	rotation: Quaternion.Euler(0, 0, 0)
}
))
...
Car_02.addComponent(new Transform({
	position: new Vector3(160, 0, 160),
	rotation: Quaternion.Euler(0, 0, 0)
}
))
...
Car_02_Collider.addComponent(new Transform({
	position: new Vector3(160, 0, 160),
	rotation: Quaternion.Euler(0, 0, 0)
}
))
