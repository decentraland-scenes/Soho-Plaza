...
Car_Body.addComponent(new Transform({
	position: new Vector3(160, 0, 160),
	rotation: Quaternion.Euler(0, 0, 0)
}
))
...
WheelBack_L.addComponent(new Transform({
	position: new Vector3(160, 0, 160),
	rotation: Quaternion.Euler(0, 0, 0)
}
))
...
WheelBack_R.addComponent(new Transform({
	position: new Vector3(160, 0, 160),
	rotation: Quaternion.Euler(0, 0, 0)
}
))
...
WheelFront_L.addComponent(new Transform({
	position: new Vector3(160, 0, 160),
	rotation: Quaternion.Euler(0, 0, 0)
}
))
...
WheelFront_R.addComponent(new Transform({
	position: new Vector3(160, 0, 160),
	rotation: Quaternion.Euler(0, 0, 0)
}
))
